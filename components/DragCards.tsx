...
export const DragCards = () => {
  ...
  return (
    <section className="relative grid min-h-screen w-full place-content-center overflow-hidden bg-neutral-950">
      ...
      <Cards openImageModal={openImageModal} />
  ...
  return (
    <div className="absolute inset-0 z-10" ref={containerRef}>
      ...
      <Card
        ...
        openImageModal={openImageModal}
      />
      {/* Add other Card instances here, each passing openImageModal as a prop */}
    </div>
  );
};
...
const Card = ({
  ...
  return (
    <motion.img
      ...
      onDoubleClick={() => openImageModal(src)} // Open modal on double click
      style={{
        top,
        left,
        rotate,
...
const Modal = ({ src, closeModal }: ModalProps) => (
  <div
